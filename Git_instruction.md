...
5. Для создания обзорной страницы просмотра проекта:
    ...
    - создаём ссылку на проект: внутри квадратных скобок пишем текст, который будет отображаться в файле "README.md" и рядом (без пробела) в круглых скобках прописываем ссылку: [текст] (https://arturius101.github.io/.../)
