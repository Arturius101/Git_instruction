...
5. Для создания обзорной страницы просмотра проекта:
    ...
    - внутри квадратных скобок "[]" пишем текст, который будет отображаться в файле "README.md" и рядом (без пробела) в круглых скобках прописываем ссылку: https://arturius101.github.io/.../
